// In-app update checking — mirrors Quarc Music's, Notes', and Weather's exact
...
const REPO = 'zekicandemiralay/Quarc_Translate';
...
/**
 * One-shot check used by the Settings screen.
